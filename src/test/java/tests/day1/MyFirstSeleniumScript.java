...
public class MyFirstSeleniumScript {
    public static void main(String [] args){
       ...
       // System.setProperty("webdriver.chrome.driver", "/path/chromedriver"); ====>old way of Webdriver setup
        WebDriverManager.chromedriver().setup();
        //we need to create an object of appropriate class
        ChromeDriver driver = new ChromeDriver();
        //open google.com
        //.get() method allows to open some website
        driver.get("http://google.com");//==>to open the page
        ...
        driver.close(); // ===> closes the cureent tab not all the app
    }
}
